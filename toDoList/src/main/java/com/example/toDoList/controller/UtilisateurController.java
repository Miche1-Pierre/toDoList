...
import com.example.toDoList.security.IsAdmin;
import com.example.toDoList.security.IsUser;
...
public class UtilisateurController {
    ...
    public ResponseEntity<Utilisateur> update(
        ...
        if(utilisateurEnvoye.getTaches() == null) {
            utilisateurEnvoye.setTaches(utilisateurBaseDeDonne.getTaches());
        }
        //idem pour status
    ...
    public ResponseEntity<List<Tache>> getTachesByUtilisateur(@PathVariable Integer id) {
        List<Tache> taches = tacheDao.findTachesByUtilisateurId(id);
        if (taches.isEmpty()) {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
